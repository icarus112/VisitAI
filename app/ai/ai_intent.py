...
- список из 1-5 слов или коротких фраз для поиска услуги
- не добавляй дату и время
- не добавляй лишние слова типа "хочу", "можно", "запишите"
...
Правила для comment:
- сюда помещай дополнительные пожелания клиента, которые не являются услугой, датой или временем
